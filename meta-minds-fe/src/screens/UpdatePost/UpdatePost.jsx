    ...
    <div>
      ...
      <div className="update-post-page">
        <form onSubmit={handleSubmit}>
            ...
            <div className="update-details-top-left">
              <label className="update-post-label-and-input-div update-category-div">
                ...
                {category === "Mana" ? (
                  ...
                  >
                    <option value="Mana" selected="selected">
                      {category}
                    </option>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="Meta" selected="selected">
                      {category}
                    </option>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="Crypto" selected="selected">
                      {category}
                    </option>
                    <option value="Meta">Meta</option>
                    <option value="Mana">Mana</option>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="Film" selected="selected">
                      {category}
                    </option>
                    <option value="Meta">Meta</option>
                    <option value="Mana">Mana</option>
              ...
              <label className="update-post-label-and-input-div update-image-div">
                <div>
                  {loading ? (
                    ...
                    <img
                      className="update-uploaded-image"
                      src={image}
                      alt="new-post"
                    />
                  )}
                ...
                <label htmlFor="file-inputs">
                  {(loading && image === "") || image !== "" ? (
                    ...
                    <img
                      className="image-upload-icon-update"
          ...
          subtitle.length === 0 ||
          content.length === 0 ? (
            <button className="update-button-disabled" disabled="true">
              Update
            </button>
          ) : (
      ...
      <div className="update-posts-mobile">
        {image !== "" ? (
          <img
            className="updates-post-close-icon"
            src="https://res.cloudinary.com/tylerwashington98/image/upload/v1639678942/Meta-Minds/icons8-remove-image-30_1_zythir.png"
            alt="close-icon"
            onClick={() => setImage("")}
          ></img>
        ) : (
          <div className="updates-post-close-icon"></div>
        )}
        <form className="create-post-form-update" onSubmit={handleSubmit}>
          ...
          <label className="create-post-label-and-input-div image-div">
            <div>
              {loading ? (
                ...
                <img
                  className="uploaded-image-update"
                  src={image}
                  alt="new-post"
                />
              )}
