        ...
        <div className="view-post-upper-details-div">
          <div className="view-post-upper-details-div-left">
            <div className="view-post-created-at-and-category">
              <div className="view-post-created-at">
              ...
              <Link
                to={`/${post?.category}`}
                className="single-post-category-link"
              >
                <div className="view-post-category">{post?.category}</div>
              </Link>
            </div>
            ...
            <div className="view-post-option-and-name-div-mobile">
              <div className="view-post-created-name-mobile">
                {user[0]?.username}
              </div>
              <div className="options-and-drop-down-mobile-div">
                <img
                  className="view-post-edit-or-delete-option-mobile"
                  src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638566267/option_nqo2as.png"
                ...
                {isOpen &&
                  (currentUser && currentUser?.id === post?.user_id ? (
                      ...
                      >
                        <div className="edit-post-div">
                          <img
                            ...
                            src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638767523/Meta-Minds/icons8-edit-30_c4n4wb.png"
                          ></img>
                          <div className="edit-post-text">Edit Post</div>
                        </div>
                      </Link>
                      <div
                        onClick={() => setFinalDelete(!finalDetete)}
                        className="delete-post-div"
                      >
                        <img
                          className="delete-post-icon"
                          src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638767542/Meta-Minds/icons8-delete-48_ujlv7r.png"
                        ></img>
                        <div className="delete-post-text">Delete Post</div>
                      </div>
                      <div onClick={copy} className="copy-post-url-div">
                        <img
                          className="copy-link-icon-one"
                          src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638893598/Meta-Minds/icons8-link-50_jaqddt.png"
                        ></img>
                    ...
                    <div
                      onClick={copy}
                      className="view-post-show-options-dropdown-two-mobile"
                    >
                      <div className="copy-post-url-div-two">
                        <img
                          className="copy-link-icon-two"
                          src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638893598/Meta-Minds/icons8-link-50_jaqddt.png"
                        ></img>
          ...
          <div className="view-post-option-and-name-div">
            <img
              className="view-post-edit-or-delete-option"
              src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638566267/option_nqo2as.png"
              onClick={() => setIsOpen(!isOpen)}
              alt="banner-mage"
            ></img>
          ...
          {isOpen &&
            (currentUser && currentUser?.id == post?.user_id ? (
              ...
              <div
                onClick={copy}
                className="view-post-show-options-dropdown-two"
              >
                <div className="copy-post-url-div-two">
                  <img
                    className="copy-link-icon-two"
          ...
          {copied && (
            <div className="clipboard-div">
              <img
                ...
                src="https://res.cloudinary.com/tylerwashington98/image/upload/v1638902968/Meta-Minds/icons8-task-completed-48_tteo9y.png"
              ></img>
              <div className="Link-to-text">Link copied to clipboard</div>
              <a className="href-text" href={`/view-post/${post?.id}`}>
                View Post
              </a>
              <img
                onClick={() => setCopied(false)}
                className="exit-clipboard-icon"
                src="https://res.cloudinary.com/tylerwashington98/image/upload/v1637356989/Meta-Minds/icons8-xbox-x-30_b6ugfl.png"
              ></img>
            </div>
          )}
          {finalDetete && (
            ...
            {firstTwoPosts?.map((simPost) => {
              return (
                <div className="each-similar-post" key={simPost?.id}>
                  <Link
                    to={`/view-post/${simPost?.id}`}
                    className="single-post-title-link"
                  >
                    <img
                      className="each-similar-post-image"
                      src={simPost?.image}
                      alt="similar-post"
                    ></img>
                  </Link>
                  <div className="each-similar-post-details-div">
                    <div className="each-similar-post-details-div-text">
                      <div className="each-similar-post-cretated-at-and-category-div">
                        <h5 className="each-similar-post-cretated-at-text">
                          {DateTime.fromISO(
                            `${simPost?.created_at}`
                        ...
                        <Link
                          ...
                          className="single-post-category-link"
                        >
                          <div className="each-similar-post-catgeory-text">
                            {simPost?.category}
                          </div>
                        </Link>
                      </div>
                      <Link
                        ...
                        className="single-post-title-link"
                      >
                        <h1 className="each-similar-post-title">
                          {simPost?.title}
                        </h1>
                      </Link>
                    </div>
            ...
            {firstTwoPosts?.map((simPost) => {
              return (
                <div className="vp-each-single-mobile-post" key={simPost?.id}>
                  <Link
                    to={`/view-post/${simPost?.id}`}
                    className="vp-each-single-mobile-post-image-link"
                  >
                    <img
                      className="vp-each-single-mobile-post-image"
                      src={simPost?.image}
                      alt={simPost?.title}
                    />
                  </Link>
                  <div className="vp-each-single-mobile-post-details-div">
                    <div className="vp-each-single-mobile-post-details-date-and-category-div">
                      <div className="vp-each-single-mobile-post-details-date">
                        {DateTime.fromISO(
                          `${simPost?.created_at}`
                        ).toLocaleString(DateTime.DATE_MED)}
                      </div>
                      <Link
                        to={`/${simPost?.category}`}
                        className="vp-single-post-category-link"
                      >
                        {" "}
                        <div className="vp-each-single-mobile-post-details-category">
                          {simPost?.category}
                        </div>
                      </Link>
                    </div>
                    <Link
                      to={`/view-post/${simPost?.id}`}
                      className="vp-each-single-mobile-post-details-title vp-single-post-category-link"
                    >
                      {simPost?.title}
                    </Link>
                  </div>
